...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZGhydXYyMDAzc3dhbWkiLCJhIjoiY2w4Y3pyZHRyMHJsYTN2bXI1bHh2d3gxdyJ9.JEf3SzrlxPEed3f3sn74dw";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/dhruv2003swami/cl8d0ih5u00a014qq42dgoz8c/draft",
    scrollZoom: false //   center: [-118.1238400702876, 34.01201319520277],
    //   zoom: 4,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); // extend map bound to include current locations
...
var stripe = Stripe("pk_test_51LmblRSJuVTEb9gXnP4SgXjGKYcPLtjtEuUJDCb2BUOI9wqe8PDYqgT7Gfj4SwnWIqINoTdVwSyOABVm8cnXykDc00VI6Q7UM8");
...
var bookBtn = document.getElementById("book-tour"); // DELEGTION
